...
if (isset($_SESSION['admin'])) {
    ...
    //obtener datos para producto
    $id = $_GET['id'];
    $consulta = 'SELECT p.id,c.id as idcategory,c.nombre as categoria ,p.nombre,p.descripcion,p.precio,p.cantidad,p.url
                FROM producto p inner join category c on c.id = p.idcategory where p.estado=1 and p.id=?';
    //  $consulta = 'SELECT * FROM producto where estado = 1 ';
    $sql_producto = $consulta;
    $sentencia_producto = $pdo->prepare($sql_producto);
    $sentencia_producto->execute(array($id));
    $resultado_producto = $sentencia_producto->fetch();
}

//    var_dump($resultado_producto['idcategory']);
                            ...
                            <div class="card-panel">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                        <div class="input-field col s12">
                                            <input id="name" type="text" name="nombre" required value="<?=$resultado_producto['nombre']; ?>" >
                                            <input type="hidden" value='<?=$resultado_producto['id']; ?>' name="idproducto">
                                        ...
                                        <div class="row">
                                        <div class="input-field col s12">
                                            <input id="descripcion" type="text" name="descripcion" required value="<?=$resultado_producto['descripcion']; ?>">
                                        ...
                                        <div class="row">
                                        <div class="input-field col s12">
                                            <input id="precio" type="text" name="precio" required value="<?=$resultado_producto['precio']; ?>">
                                        ...
                                        <div class="row">
                                        <div class="input-field col s12">
                                            <input id="cantidad" type="text" name="cantidad" required value="<?=$resultado_producto['cantidad']; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <?= '<img src="data:image/jpeg;base64,'.base64_encode($resultado_producto['url']).' " class="img-responsive" style="height: 300px; width: 350px" />'; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                            <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Actualizar Producto
