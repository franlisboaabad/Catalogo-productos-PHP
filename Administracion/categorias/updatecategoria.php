...
//Obtener dato por medio de get - incluir   a los input por medio de php 
if($_GET){

    $id = $_GET['id'];

    $sql_category = 'SELECT * FROM category where id=?  and estado=1';
    $sentencia_category = $pdo->prepare($sql_category); // pasar consulta preparada
    $sentencia_category->execute(array($id));// filtro para buscar en consulta
    $resultado_category = $sentencia_category->fetch(); // resultado y solo un solo dato
}
    ...
    <div id="main">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i> Manteniiento Página</a>
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li><a href="css-icons.html">Productos</a>
                                    </li>
        ...
        <div id="breadcrumbs-wrapper" class=" grey lighten-3">
          <div class="container">
            ...
            <div class="row">
                <a href="categorias.php" class="btn waves-effect waves-light indigo">Lista de categorias</a>
                <hr>
            </div>
                                ...
                                <div class="row">
                                    <form class="col s12" method="POST" action="update.php">
                                        ...
                                        <div class="input-field col s12">
                                            <input id="name" type="text" name="nombre" value="<?=$resultado_category['nombre']; ?>">
                                            <label for="first_name">Nombre</label>
                                        </div>
                                        </div>
                                        <div class="row">
                                        <div class="input-field col s12">
                                            <input id="category" type="text" name="descripcion" value="<?=$resultado_category['descripcion']?>">
                                            <label for="descripcion">Descripcion</label>
                                            <input id="idcategory" type="hidden" name="id" value="<?=$resultado_category['id']?>">
                                        </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                            <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Actualizar categoria
