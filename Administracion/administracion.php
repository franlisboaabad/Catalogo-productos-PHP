...
if (isset($_SESSION['admin'])) {
    ...
    //si no encuentro session activa - regreso a login
}
...
<head>
    ...
    <title>Panel de Administración / Catalogo de productos</title>
...
<body>
    ...
    <div id="main">
        ...
        <div id="card-stats" class="seaction">
              <h4 class="header">CATALOGO DE PRODUCTOS - PANEL PRINCIPAL</h4>
              <div class="row">
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content purple white-text">
                                        <p class="card-stats-title"><i class="mdi-editor-attach-money"></i>Productos</p>
                                        <h4 class="card-stats-number"><?=$number_of_rows?></h4>
